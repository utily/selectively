...
describe("selectively.Type", () => {
	...
	it("Multiplication and Addition", () => {
		const multiplyAddition = new Multiplication(new Addition(4, 3), new Multiplication(1, 2))
		expect(multiplyAddition).toMatchSnapshot()
		expect(multiplyAddition.toString()).toMatchSnapshot()
		expect(multiplyAddition.operate()).toMatchSnapshot()
	})
	it("Addition and Multiplication", () => {
		...
		expect(addMultiplication.operate()).toMatchSnapshot()
	})
})
